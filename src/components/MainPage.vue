    ...
    <v-row>
      <v-col>
        ...
        >
          ...
          <!-- Inner card 1 -->
          <v-card class="box1" max-width="100%" height="80px" color="#ffffff4d">
            <div class="add-task">
          ...
          >
            ...
            <!-- Task Table -->
            <v-table class="table" height="300px">
              <thead>
                <tr>
                  <th>Name</th>
                  <th>Status</th>
...
body {
  ...
  background-image: linear-gradient(
      ...
      rgba(22, 49, 113, 0.5) 4%
    ),
    linear-gradient(
      44deg,
      rgba(0, 43, 99, 0.079) 39%,
      rgba(142, 28, 32, 0.5) 18%
    ),
    linear-gradient(
      118deg,
